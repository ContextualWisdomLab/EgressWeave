...
- [README](../README.md) — installation, quickstart, API, compatibility, and security behavior.
...
- [Architecture](../ARCHITECTURE.md) — protected-main implementation architecture.
